...
@Model.register("syntactic-entailment-v1-abl")
class SyntacticEntailment(Model):
    ...
    def forward(self,  # type: ignore
        ...
        batch_size, _, _ = embedded_premise.shape
        p_parse_encoder_final_state = embedded_premise.new(randn(batch_size, self._parser.encoder.get_output_dim()))
        h_parse_encoder_final_state = embedded_hypothesis.new(randn(batch_size, self._parser.encoder.get_output_dim()))
